...
export const routes: Routes = [
    ...
    {
        path: 'servers',
        loadComponent: () => import('./features/servers/servers.component')
            .then(m => m.ServersComponent),
        data: {
            title: 'Servers',
            icon: 'server',
    ...
    {
        path: 'data',
        loadComponent: () => import('./features/data/data-layout/data-layout.component')
            .then(m => m.DataLayoutComponent),
        children: [
            {
                path: '',
                redirectTo: 'local',
            ...
            {
                path: 'local',
                loadComponent: () => import('./features/data/local/local.component')
            ...
            {
                path: 'extract',
                loadComponent: () => import('./features/data/extract/extract.component')
            ...
            {
                path: 'workshop',
                loadComponent: () => import('./features/data/workshop/workshop.component')
                    .then(m => m.WorkshopComponent),
    ...
    {
        path: 'mods',
        loadComponent: () => import('./features/mods/mods-layout/mods-layout.component')
            .then(m => m.ModsLayoutComponent),
        canActivate: [pathDetectedGuard],
        children: [
            {
                path: '',
            ...
            {
                path: 'install',
                loadComponent: () => import('./features/mods/install/install.component')
                    .then(m => m.InstallComponent),
                data: {
                    title: 'Install Mods',
                    icon: 'cloud-download',
            ...
            {
                path: 'bundle',
                loadComponent: () => import('./features/mods/bundle/bundle.component')
                    .then(m => m.BundleComponent),
                data: {
                    title: 'Bundle Mods',
                    icon: 'box',
    ...
    {
        path: 'hotkeys',
        loadComponent: () => import('./features/hotkeys/hotkeys.component')
            .then(m => m.HotkeysComponent),
        data: {
            title: 'Hotkeys',
            icon: 'keyboard',
