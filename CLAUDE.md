...
- 007-settings-persistence-detail-ux: Added TypeScript 5.8.3 (Angular 20.3.15), Rust edition 2021 (Tauri 2.x) + Angular Signals, Tauri plugin-store
- 007-settings-persistence-detail-ux: Added TypeScript 5.8.3 (frontend), Rust edition 2021 (backend) + Angular v20.3.15, Tauri 2.x, DaisyUI v5.5.14, Tailwind CSS v4.1.18, Transloco 8.x
