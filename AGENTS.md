...
## Recent Changes
- 003-ux-improvements: Added TypeScript 5.8.3 (Angular 20.3.15) + Rust (edition 2021; Tauri 2.x) + Angular CDK 20.2.14 (virtual scrolling), Tauri 2.x (desktop framework), quick-xml (Rust XML parsing), Transloco (i18n), Tailwind CSS 4.x + DaisyUI 5.x
- 003-ux-improvements: Added TypeScript 5.8.3 (Angular 20.3.15) + Rust (edition 2021; Tauri 2.x) + Angular CDK 20.2.14 (virtual scrolling), Tauri 2.x (desktop framework), quick-xml (Rust XML parsing), Transloco (i18n), Tailwind CSS 4.x + DaisyUI 5.x
- 003-ux-improvements: Added TypeScript 5.8.3 (Angular 20.3.15) + Rust (edition 2021; Tauri 2.x) + Angular CDK 20.2.14 (virtual scrolling), Tauri 2.x (desktop framework), quick-xml (Rust XML parsing), Transloco (i18n), Tailwind CSS 4.x + DaisyUI 5.x
